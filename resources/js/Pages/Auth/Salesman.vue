                ...
                <v-row>
                    ...
                    <v-col>
                        <v-sheet min-height="40vh" rounded="lg">
                            <v-container>
                                <v-data-table :headers="headers" :items="salesmen" item-value="profile" :items-per-page="5"
...
export default {
    ...
    methods: {
        ...
        deleteItemConfirm() {
            this.dataForm.delete(route('salesman.destroy',this.editedItem.id), {
                preserveScroll: true,
            });
            this.closeDelete()
        },
        ...
        async save() {
            ...
            if (valid){
                ...
                if(this.editedItem.id === ''){
                    this.dataForm.post(route('salesman.store'), {
                        preserveScroll: true,
                        onSuccess: () => {
                            this.dataForm.reset();
                        },
                ...
                {
                    this.dataForm.put(route('salesman.update',this.dataForm.id), {
                        preserveScroll: true,
                        onSuccess: () => {
                            this.dataForm.reset();
                        },
