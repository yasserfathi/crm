                ...
                <v-row>
                    ...
                    <v-col>
                        <v-sheet min-height="40vh" rounded="lg">
                            <v-container>
                                <v-data-table :headers="headers" :items="services" item-value="profile" :items-per-page="5"
...
export default {
    ...
    methods: {
        ...
        deleteItemConfirm() {
            this.dataForm.delete(route('service.destroy',this.editedItem.id), {
                preserveScroll: true,
            });
            this.closeDelete()
        },
        ...
        async save() {
            ...
            if (valid){
                ...
                if(this.editedItem.id === ''){
                    this.dataForm.post(route('service.store'), {
                        preserveScroll: true,
                        onSuccess: () => {
                            this.dataForm.reset();
                        },
                ...
                {
                    this.dataForm.put(route('service.update',this.dataForm.id), {
                        preserveScroll: true,
                        onSuccess: () => {
                            this.dataForm.reset();
                        },
